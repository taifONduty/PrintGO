...
// Visa wordmark + Mastercard interlocking circles.
export function CardLogos({ height = 20 }: { height?: number }) {
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
      <svg height={height} viewBox="0 0 60 20" role="img" aria-label="Visa">
        <text
          x="0"
          y="17"
      ...
      <svg height={height} viewBox="0 0 40 26" role="img" aria-label="Mastercard">
        ...
        <path
          d="M20 4.6a11 11 0 010 16.8 11 11 0 010-16.8z"
          fill="#FF5F00"
        />
      </svg>
    </div>
